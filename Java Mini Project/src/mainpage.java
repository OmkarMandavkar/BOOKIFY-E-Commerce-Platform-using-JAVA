...
class pageone extends JFrame implements ActionListener 
 {
    ...
    pageone()
	{
        ...
        img = new ImageIcon("Images/MainBg.jpg");

        bg = new JLabel("", img, JLabel.CENTER);
        bg.setBounds(0, 0, 1366, 768);

        
        fn = new Font("Times New Roman", Font.PLAIN, 20);
        fn1 = new Font("Centeria Script", Font.BOLD, 45);
        fn2 = new Font("Times New Roman", Font.PLAIN, 15);
